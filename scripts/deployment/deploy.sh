...
echo "  pipx install ./dist/ai_companion-*.whl"
echo ""
echo -e "${YELLOW}For pip installation:${NC}"
echo "  pip install ./dist/ai_companion-*.whl"
echo ""
...
echo "1. Install with pipx: pipx install ./dist/ai_companion-*.whl"
echo "2. Run: ai-companion"
